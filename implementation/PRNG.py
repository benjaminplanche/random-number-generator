...
print("# Test 1.2 - LFSR with x^16 + x^5 + x^3 + x^2 + 1 as feedback polynomial and 0xACE1 = 44257 as initial value")
...
print('# Test 2.2 - using the LFSR with x^16 + x^5 + x^3 + x^2 + 1 as feedback polynomial and 0xACE1 = 44257 as initial value')
...
lfsr4FromNlfsrMethod = createNLFSRgenerator(([0],[],[],[3]), 13)()
print("Values:")
...
print("# Test 3.2 - Poor NLFSR with x^4*x^4*x^3 + x^1*x^2 + x^1 + 1 as feedback polynomial and 13 as initial value")
poorNlfsr = createNLFSRgenerator(([0,0,1],[],[3,2],[3]), 13)()
print("Values:")
...
nlfsr4 = createNLFSRgenerator(([0],[1],[2],[1,2]), 13)()
print("Values:")
